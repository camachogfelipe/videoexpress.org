...
function BytesUploaded(
	...
	__filemonitor.onLoad = function(s) {
		...
		if(s && this.filesize && this.filesize != 'undefined')
			...
			whatsup = '<img src="imagenes/info.png" width="48" height="48" align="absmiddle" /><span id="info">Ejecutando las operaciones necesarias ...<br />Por favor no cierre esta ventana ni recargue la p&aacute;gina</span>';
			if(__maybesomethingwrong++ > 10) {
				__fileloaderInterval = 0;
				whatsup = 'La carpeta tmp parece ser no v&aacute;lida.';
			}
		}
		else {
			whatsup = 'No se puede encontrar la informaci&oacute;n del servidor.';
			__fileloaderInterval = 0;
		}
