...
// -----------------------------------------------------------------------------
class simple_html_dom_node extends JObject {
    var $nodetype = HDOM_TYPE_TEXT;
    var $tag = 'text';
    var $attr = array();
    var $children = array();
    var $nodes = array();
    ...
    // seek for given conditions
     ...
     function match($exp, $pattern, $value) {
        switch ($exp) {
            case '=':
...
// -----------------------------------------------------------------------------
class simple_html_dom extends JObject {
    var $root = null;
    var $nodes = array();
    var $callback = null;
    var $lowercase = false;
    ...
    var $self_closing_tags = array('img'=>1, 'br'=>1, 'input'=>1, 'meta'=>1, 'link'=>1, 'hr'=>1, 'base'=>1, 'embed'=>1, 'spacer'=>1);
    var $block_tags = array('root'=>1, 'body'=>1, 'form'=>1, 'div'=>1, 'span'=>1, 'table'=>1);
    var $optional_closing_tags = array(
    ...
    // parse attributes
     function parse_attr($node, $name, &$space) {
    ...
    // as a text node
     ...
     function copy_until_char_escape($char) {
        if ($this->char===null) return '';
    ...
    // remove noise from html content
     function remove_noise($pattern, $remove_tag=false) {
