...
jQuery.validator.addMethod("letterswithbasicpunc", function(value, element) {
	return this.optional(element) || /^[a-z-.,á-ú, Á-Ú, ñ, Ñ, ä-ü, Ä-Ü,()'\"\s]+$/i.test(value);
}, "Letters or punctuation only please");  

jQuery.validator.addMethod("alphanumericnospacenoaccent", function(value, element) {
	return this.optional(element) || /^[a-z-.,-,_, 0-9,^\s]+$/i.test(value);
}, "Letters, numbers, spaces or underscores only please");    

jQuery.validator.addMethod("alphanumeric", function(value, element) {
	return this.optional(element) || /^[a-z-.,á-ú, Á-Ú, ñ, Ñ, ä-ü, Ä-Ü,-,_, 0-9,()'\"\s]+$/i.test(value);
}, "Letters, numbers, spaces or underscores only please");    
