...
// check session variable
	...
	$result = consulta_bd("pedidos","*","1;;;id_factura='$id_insertado';");
	...
	elseif($existe == 0)
	{
		$sql = consulta_bd("clientes","*","1;;;id_cliente='$id_comprador';");	
	...
	$query = consulta_bd("datos","factura_del, factura_al, resolucion_dian, fecha_res_dian","-1;;;;");
            ...
            <td valign=\"top\">
             <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
              <tr>
                ...
                <td align='center' width=\"67%\" rowspan=\"5\" align=\"center\"><img src=\"http://www.libroexpress.org/catalogo/imagenes/Imagenes de edicion/logo.png\" width=\"100\" height=\"37\" /></td>
              </tr>
              <tr>
        ...
        <td height=\"92\" style=\"border:1px solid #66CC99\">
         <table width=\"100%\" height=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
          ...
          <tr>
			...
			if($alquiladas = true) $cuerpo .= "Las películas en compra se pueden cancelar con el valor del alquiler<p>Las películas en alquiler se recogerán a partir de $fecha_recogida</p>";
...
";
	...
	mail("gerencia@videoexpress.org","Nuevo pedido","Hay un nuevo pedido en Videoexpress",$headers);
?>
