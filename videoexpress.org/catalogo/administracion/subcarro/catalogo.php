...
$carro=$_SESSION['carro_admin'];else $carro=false;
...
<script type="text/javascript" src="jquery.chromatable-1.3.0/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="jquery.chromatable-1.3.0/jquery-ui-1.7.2.custom.min.js"></script>
<script type="text/javascript" src="jquery.chromatable-1.3.0/jquery.chromatable.js"></script>
...
<table id="tabla_catalogo" width="95%" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid #000000;">
  ...
  <tr align="center" valign="middle" bordercolor="#FFFFFF" bgcolor="#DFDFDF" class="catalogo"> 
    ...
    <th colspan="4" align="left"><span id="menu_admon2"><a href="ver_carrito.php" title="Ver el contenido del carrito"><img src="vercarrito.png" width="25" height="26" border="0"> Ver el carrito</a></span></th>
  </tr>
  ...
  ?>
   <tr valign="middle" class="catalogo">
	...
	elseif ($row['precio_compra'] > 0) echo "<a href=\"agregacar.php?SID&id=$id&tipo_pedido=compra\"><img src=\"../../Imagenes_pagina/no_verificado_pos.png\" width=\"15\" height=\"15\" border=\"0\"></a>";
