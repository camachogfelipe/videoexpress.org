...
<span style='color:#000; padding-left:30px'>Cuentas de VideoExpress.org</span>
</div>
...
if ($r == true && $userid != NULL && $con1 == NULL)
{
	...
	$result = consulta_bd("cat_usr","usuario_admin, correo, token","1;;;usuario_admin='$userid';");
	...
	if ($usuario == 0)
	{
		...
		$cuerpo = "Hola $user
Este es un correo de VideoExpress.org para confirmar la recordación de tu clave de acceso al portal de administración del catalogo.

Por favor da click al siguiente vinculo para confirmar la recordación de tu clave:

http://www.videoexpress.org/catalogo/administracion/recordacion.php?re=true&to=$token&userid=$userid
...
La función de este mensaje es &uacute;nicamente informativa. Las respuestas no se supervisar&aacute;n ni se contestar&aacute;n."; 
		...
		$headers .= "From: Soporte <soporte@videoexpress.org>\n"; 
		mail($mail, $asunto, $cuerpo, $headers);
		
		echo "<div style='padding: 5px; width: 350px; border: 2px solid #D5ECFF; margin-left:20px; margin-top:10px'>";
...
if ($userid != NULL && $to != NULL && $recuperacion == true)
{
	...
	{
		// Si están en la base de datos del registro de usuario
		echo "<div style=\"margin-left:20px\"><p style='font-weight:bold'>Restablecer contrase&ntilde;a</p>
			  ...
			  <table width='400' border='0'>
			   <tr>
				...
				<td width='50%'><input type='password' name='con1'></td>
			   </tr>
			   <tr>
			    <td>Vuelva a escribir la contrase&ntilde;a</td>
				<td><input type='password' name='con2'></td>
			   </tr>
			  </table>
...
if ($con1 != NULL && $con2 != NULL)
{
	...
	if ($con == 0)
	{
		...
		echo "<div style='padding: 5px; width: 350px; border: 2px solid #D5ECFF; margin-left:20px'>";
...
{
	echo "<div style=\"padding: 20px\"><p style='font-weight:bold'>¿Ha olvidado su contrase&ntilde;a?</p>
		 Para iniciar el proceso de recuperación de contraseña, por favor, introduzca su nombre de usuario de VideoExpress.org.
		 </div>
		 <div style='padding-top: 5px; padding-right: 5px; padding-left: 5px; padding-bottom: 0px; width: 340px; border: 2px solid #D5ECFF; margin-left: 20px'  vertical-align='text-middle'>
...
<p><a id="flechas" onclick="history.go(-1)" ><img src="../botones/botonatras.png" align="left" width="25" height="25" alt="Regresar" /> &nbsp;&nbsp;Regresar</a></p></div>
<div style="background-color:#D5ECFF; color:#000; padding-left:30px; margin-top: 10px">
&copy; 2011 VideoExpress.org
</div>
</body>
</html>