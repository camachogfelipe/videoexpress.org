...
if(isset($_SESSION['carro_admin_mod'])) $carro=$_SESSION['carro_admin_mod'];else $carro=false;
...
?>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  	...
  	$contador=0;
  	$suma=0;
	$subto_compra = $subto_cortesia = $subto_alquiler = $suma = $ta = $tc = $tr = $valor_alquiler = $subto_afiliacion = 0;
  	$valor_alquiler = $_SESSION['alquiler_admin'];
  	foreach($carro as $k => $v)
  	{
		if ($v['tipo_pedido'] == 'alquiler') $ta += 1;
		if ($v['tipo_pedido'] == 'Afiliación') $ea = 1;
	}
	foreach($carro as $k => $v)
  	{
		$id = $v['id'];
		...
		if($ea == 1) $subto_alquiler = 0;
    	$suma=$subto_alquiler+$subto_compra+$subto_afiliacion;
    	$contador++;
    	?>
	   	...
	   	if ($v['tipo_pedido'] == 'Afiliación')
		{
			...
			<td align="center"><img src=../../Imagenes_pagina/no_verificado_pos.png width=15 height=15 border=\"0\"></td>
			<td align="center"><img src=../../Imagenes_pagina/no_verificado_pos.png width=15 height=15 border=\"0\"></td>
			<td with="62" align="center"><?php echo $v['cantidad']; ?></td>
			<td width="150">&nbsp;</td><td width="34">&nbsp;</td>
			<td align="right">$ <?php echo number_format($_SESSION['afiliacion_admin'], 2); ?>
			</td>
            </tr>
        <?php
		}
    	...
    	<tr bgcolor="#FFFFFF" class='prod'>
          ...
          if ($v['tipo_pedido'] == 'compra') echo "<img src=\"../../Imagenes_pagina/verificado_pos.png\" width=\"15\" height=\"15\" border=\"0\">";
	  	  else echo "<a href=\"agregacarmod.php?SID&id=$id&tipo_pedido=compra\"><img src=\"../../Imagenes_pagina/no_verificado_pos.png\" width=\"15\" height=\"15\" border=\"0\"></a>"; ?></td>
      	  <td align="center">
		  <?php
          ...
          <input name="id" type="hidden" id="id" value="<?php echo $v['id'] ?>">
      	  ...
      	  <td width="34" align="center"><a href="borracarmod.php?<?php echo SID ?>&id=<?php echo $v['id'] ?>&tipo_pedido=<?php echo $v['tipo_pedido'] ?>"><img src="../../Imagenes_pagina/caneca.png" width="15" height="15" border="0"></a></td>
      	  <td align="right">$ 
		  <?php
		  if ($v['tipo_pedido'] == 'alquiler' and $ea != 1) echo number_format($valor_alquiler, 2);
		  elseif($ea == 1) echo number_format('0');
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  	  <tr>
    	<td width="50%" align="right" style="padding-right: 10px"><a href="anularmod.php"><img src="../../Imagenes_pagina/cancelar_pedido.png" width="100" height="25" border="0" /></a></td>
    	<td width="50%" align="left" style="padding-left: 10px"><a href="confirmar_pedidomod.php?<?php echo "id_fac=".$id_fac ?>"><img src="../../Imagenes_pagina/continuar_pedido.png" width="100" height="26" border="0" /></a></td>
  	  </tr>
	</table>
