...
$datos['pais']				= $_REQUEST['pais'];
$datos['ciudad']			= $_REQUEST['ciudad'];
$datos['asunto']			= $_REQUEST['razon'];
$datos['texto_contacto']	= $_REQUEST['texto_contacto'];
$datos['enviar']	 		= $_REQUEST['enviar'];
$alquiler					= $_REQUEST['alq'];
$datos['titulo']			= $_REQUEST['titulo'];

if ($alquiler == NULL || $alquiler >= 2 || $alquiler <= -1)
{
	$alquiler = 0;
}

if ($enviar = 'true' && $nombre != NULL)
{
	mail_contacto($datos);
}
?>
...
obligatorio = ["nombre", "email", "telefono", "ciudad", "texto_contacto"];
vacio = 0;

//Pon en la veriable textoObligatorio el texto que quieres que aparezca en el alert

textoObligatorio=["Nombre", "E-mail", "Telefono o celular", "Ciudad", "Texto del contacto"];
...
<center>
<div id="contacto" style="text-align:left">
<form id="form1" name="form1" method="post" action="contacto.php?enviar=true" onSubmit="return comprobar(this)">
<table width="100%" border="0" cellspacing="2px" cellpadding="0">
  <tr>
    <td>
     <table width="100%" border="0" cellspacing="2px" cellpadding="0">
      <tr>
       <td width="200" class="parrafo">Nombre</td>
       <td><label>
         <input name="nombre" type="text" id="nombre" tabindex="1" size="35" />
       </label></td>
      </tr>
      <tr>
       <td><span class="parrafo">E-mail</span></td>
       <td><label>
         <input name="email" type="text" id="email" tabindex="2" size="35" />
       </label></td>
      </tr>
      <tr>
       <td><span class="parrafo">Tel&eacute;fono</span></td>
       <td><label>
         <input name="telefono" type="text" id="telefono" tabindex="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue=false;" maxlength="10" />
       </label></td>
      </tr>
      <tr>
       <td><span class="parrafo">Pa&iacute;s</span></td>
       <td><label>
      ...
      <tr>
       <td><span class="parrafo">Ciudad</span></td>
       <td><label>
         <input name="ciudad" type="text" id="ciudad" tabindex="5" size="35" />
       </label></td>
      </tr>
      <tr>
       <td><span class="parrafo">Raz&oacute;n del contacto</span></td>
       <td>
        <?php
			if ($alquiler == 1)
			{
		?>
        <label>
         <select name="razon" id="razon" tabindex="6" disabled="disabled">
           <option value="alquiler" selected="selected">Alquiler de peliculas</option>
         </select>
        </label>
        <?php
			}
		...
		?>
        <label>
         <select name="razon" id="razon" tabindex="6">
  ...
  <tr>
    ...
    <?php
		...
		{
	?>
    <span class="parrafo">El titulo a alquilar es:</span>
    <label><input name="ciudad" disabled="disabled" type="text" id="texto_contacto" value="<?php echo $titulo ?>" tabindex="7" size="40" /></label>
    <?php
		}
		elseif ($alquiler == 0)
		{
	?>
     <span class="parrafo">Escriba aqu&iacute; las razones del contacto</span><br />
     <textarea name="texto_contacto" id="texto_contacto" cols="54" rows="5" tabindex="7"></textarea>
    <?php
		}
	?>
    </td>
  ...
  <tr>
    <td style="text-align:center; vertical-align:middle"><a id="flechas" onclick="history.go(-1)" ><img src="../botones/botonatras.png" align="left" width="25" height="25" alt="Regresar" /></a><a href="javascript:document.form1.reset()"><img src="../Imagenes_pagina/limpiar.png" width="100" height="25" border="0" /></a>
      &nbsp;<input type="image" src="../Imagenes_pagina/boton_enviar.png" name="submit" value="submit" /></td>
  </tr>
</table>
</form>
</div>
