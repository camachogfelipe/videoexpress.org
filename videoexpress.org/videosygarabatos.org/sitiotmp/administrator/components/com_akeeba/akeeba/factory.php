 ...
 * @version $Id: factory.php 593 2011-05-11 11:10:34Z nikosdion $
 */
...
if(defined('AKEEBAROOT')) {
	...
	require_once AKEEBAROOT.DIRECTORY_SEPARATOR.'platform'.DIRECTORY_SEPARATOR.AKEEBAPLATFORM.DIRECTORY_SEPARATOR.'platform.php';
} else {
