...
if (typeof(MooTools) != 'undefined'){
		...
		Element.extend(
		{
			...
			anim: function() {
				...
				if (this.status == 'hide')
				{
					...
					else this.myFx2.start(0,this.mh/*-30*/);
				}
			},
		...
		window.addEvent('domready',function() {new DropdownMenu($('gk-cssmenu'))});
	
	}else {
	
		sfHover = function() {
		var sfEls = document.getElementById("gk-cssmenu").getElementsByTagName("li");
