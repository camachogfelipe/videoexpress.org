...
//id_empresa:
$query2 = "select empresa.id_empresa,empresa.logo,empresa.contacto, tipo_usuario.nombre_tipo_usuario from empresa,tipo_usuario where usuario = '$_SESSION[MM_Username]' and empresa.id_tipo_usuario = tipo_usuario.id_tipo_usuario ;";
$row1 = mysql_query($query2,$conexion);			           
$consulta = mysql_fetch_row($row1);
$id_empresa = $consulta[0];
$logo1 = $consulta[1];
$contacto1 = $consulta[2];
$tipo_usuario = $consulta[3];
...
<div class="superior">
	  <div class="interiorsup">
        ...
        <div id="textidentificacion"><? echo $tipo_usuario ?>
</div></div>
            <div class="contmenu">
           	  <ul class="menu" >
	  ...
	  <div class="buscador" id="texto_pie" >
		<form class="busqueda" id= "formulario" name="buscar" action="afiliaciones_afiliados.php" method="get" >
 ...
 and empresa.es_principal='no'
 and empresa.tipo='emprendedor'
 ...
 and departamento.departmentISO2Country = '$opcion'
  ...
  and clasificacion.id_clasificacion = empresa.id_clasificacion";
	...
	$total_paginas = ceil($total_registros / $cant_reg);
       ?>
	  <div class="contenido"><div class="resultados"><div class="titulo_afiliados" id="titulo1">Empresas Afiliadas</div>
...
<p id="texto_pie"><?php if ($total_paginas == 0) echo "No existen registros con esta b煤squeda"; else { ?>Resultados totales <?php echo $total_registros ?>. Mostrando <?php echo $num_pag ?><sup>a</sup> p&aacute;gina de <?php echo $total_paginas ?></p>
<? 
    	...
    	<div class="inferior">
            ...
            <div class="interiorinfenlaces">
                ...
                <img src="../images/CIEC.png" width="102" height="32" alt="ciec letra" />
                 ...
                 <div class="panelinf2">
                <a href="">Organizaci贸n<br /></a>
                <a href="">Afiliaci贸n<br /></a>
