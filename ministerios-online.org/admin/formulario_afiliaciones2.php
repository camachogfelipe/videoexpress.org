...
<div class="for_preinscripcion">
                  <h3 id="titulos1" style="text-align:left">Inscribir Ministerio/Empresa</h3>
...
">
  ...
  <tr>
    ...
    <td>País</td>
    <td align="left"><select id="pais" name="pais">
<?php
...
<?php
  ...
  <tr>
    ...
    <td align="left"><input name="tipo_asociado" id="tipo_asociado"  type="radio" value="empresario" checked="checked" />  
    Afiliado Ministerio
    <input name="tipo_asociado" id="tipo_asociado"  type="radio" value="emprendedor"  />
    Afiliado  Empresa
     </td>
...
<?php
	...
	$q ="SELECT nombre_institucion,id_empresa FROM empresa where  	es_principal ='si' ORDER BY nombre_institucion ASC";
	$row1 = mysql_query($q,$conexion);	
	while($row = mysql_fetch_row($row1)){
	$nombre3 = $row[0];
	$ide = $row[1];
	
			?>
              <option value="<?php echo $ide?>"><?php echo $nombre3 ?></option>
  ...
  <tr>
    <td>Fecha constitución del ministerio/empresa</td>
    <td align="left">
