...
<div class="superior">
	  <div class="interiorsup">
		...
		<form class="busqueda" id= "formulario" name="buscar" action="resultados.php" method="post" >
	...
	{ $nombre =iconv('ISO-8859-1','UTF-8//TRANSLIT',$row[1]);
	  $id = $row[0];
            ...
            <input type="image" src="images/btn_busqueda.png" align="middle"  onclick="valida_envio();" ></input>
        </form><form class="ingreso" id="frmLogin" name="frmLogin" method="POST" action="<?php echo $loginFormAction; ?>">
<a href="" style="color:#C00">Acceso denegado!</a><br />
