		...
		else
		{
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea name="descripcion" id="descripcion" rows="5"  ><?=eliminarInvalidos($_POST["descripcion"]); ?></textarea></td>
                </tr>
                </tbody>
            </table>
            ...
            <hr color="#0000FF" />
            <br />
            <center><input type="button" name="button" onclick="generarForm()" value="Crear Grupo" /></center>
	...
	if(isset($_GET["id"]))
	{
		...
		else
		{
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>Descripción:</strong></td>
                    <td colspan="3"><textarea name="descripcion" id="descripcion" rows="5"  ><?=$PSN->f('descripcion');?></textarea></td>
                </tr>
                </tbody>
            </table>
            <input type="hidden" name="funcion" id="funcion" value="" />
            ...
            <hr color="#0000FF" />
            <br />
            <center><input type="button" name="button" onclick="generarForm()" value="Actualizar Grupo" /></center>
            </form><script language="javascript">
                function generarForm(){
