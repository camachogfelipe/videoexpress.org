...
if(isset($_GET["doc"]) && !empty( $_GET["doc"]) && is_logged_in())
{
	...
	*/
	...
	<tr>
		<td align="left" width="30%" valign="middle" style="vertical-align:middle"><img src="images/logoanglo.png" align="middle" width="200"></td>
	...
	*/
	...
	<tr>
	<td align="right" valign="middle" bgcolor="#ffffff" colspan="3"><br /><br /><span id="footer"><center>
	  <hr color="#0000FF">
    ...
    Una alianza:
    <br />
    <img src="images/logo_ve.jpg" height="30px" /> 
    <img src="images/logo_recursos_ministeriales.png" height="30px" />
	<br />
	Copyright 2014 - <?=date("Y"); ?> <?=$gloEmpresa; ?></font><br />
    </font></center></span></td></tr></table><?
}
else
{
	?>
...
<tr><td colspan="2" align="center"><?
  ...
  <span id="footer"><center>
    ...
    Una alianza:
    <br />
    <img src="images/logo_ve.jpg" height="40px" /> 
    <img src="images/logo_recursos_ministeriales.png" height="40px" /> 
	<br />
	Copyright 2014 - <?=date("Y"); ?> <?=$gloEmpresa; ?></font><br /></center></span></td>
</table><?
}
?>
</body></html>