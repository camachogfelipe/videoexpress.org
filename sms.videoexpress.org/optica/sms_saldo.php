...
else
{
	...
	<br />
	<center><input type="button" name="button" onclick="generarForm()" value="Agregar Saldo" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"></center>
