...
if(isset($_GET["doc"]) && !empty( $_GET["doc"]) && is_logged_in())
{
	...
	*/
	...
	<tr>
		<td align="left" width="30%" valign="middle" style="vertical-align:middle"><img src="images/logoanglo.png" align="middle" width="400"></td>
...
else
{
	?>
    <center>
    <img src="images/logoanglo.png" align="middle" width="900">
    </center>
    <br />
    <table width="100%" border=0 align="center" cellpadding="0" cellspacing="0">
