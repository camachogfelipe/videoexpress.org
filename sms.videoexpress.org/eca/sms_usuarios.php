...
if($opc == 1)
{
		...
		else
		{
            ...
            <hr color="#0000FF" />
            <br />
            <center><input type="button" name="button" onclick="generarForm()" value="Crear Usuario" /></center>
...
else
{
	if(isset($_GET["id"]))
	{
		...
		else
		{
            ...
            <br />
            <center><input type="button" name="button" onclick="generarForm()" value="Actualizar Usuario" /></center>
<?
				if($_SESSION["perfil"] == 1)
				{
					?><br />
					<center><input type="button" name="button" onclick="generarFormDel()" value="Eliminar Usuario" /></center><?
				}
				?>
            </form><script language="javascript">
                function generarForm(){
	...
	else
	{
        ...
        <thead>
	        <tr>
            	<th colspan=4 align="center" valign="middle" height="40px">.FILTROS DE BUSQUEDA.</th>
            </tr>
        </thead>
        <tbody>
            <tr>
