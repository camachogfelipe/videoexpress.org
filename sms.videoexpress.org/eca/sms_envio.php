				...
				if(count($_POST['listaasociar']) > 0 && trim($listas) != "" && $listas != ",")
				{
					...
					if($num > 0)
					{
						...
						while($PSN->next_record())
						{
							...
							$xml = file_get_contents("https://sistemasmasivos.com/smsmasivo/api/sendsms/send.php?user=".urlencode("eca@iglesiaamoryrestauracion.org")."&password=y8xui6oF-A&GSM=".$sms_celular."&SMSText=".$mensajecorreo);
							//
							$retorno = explode(",", $xml);
