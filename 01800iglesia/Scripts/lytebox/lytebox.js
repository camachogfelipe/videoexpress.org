...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure Lytebox ***/
		...
		this.theme   			= (typeof lyteboxTheme !== 'undefined') && /^(black|grey|red|green|blue|gold|orange|purple)$/i.test(lyteboxTheme) ? lyteboxTheme : 'orange'; // themes: black (default), grey, red, green, blue, gold, orange, purple
	...
	case '.mov':
			...
			if (this.getQuicktimeVersion() <= 0) {
				object	= '<div style="padding:1em;">'
						...
						+ '<p><a href="http://www.apple.com/quicktime/" target="_blank"><img src="http://images.apple.com/about/webbadges/images/qt7badge_getQTfreeDownload.gif" alt="Get QuickTime"></a></p>'
						+ '</div>';
			}
			break;
		case '.avi':
		...
		case '.swf':
			...
			object 	= '<object classid="' + classId + '" width="' + w + '" height="' + h + '" codebase="' + codebase + '">'
					...
					+ '<p><a href="http://www.adobe.com/go/getflashplayer" target="_blank"><img src="http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" alt="Get Adobe Flash player" /></a></p>'
					+ '</div>'
					+ '<!--[if !IE]>-->'
					+ '</object>'
					+ '<!--<![endif]-->'
