...
function BytesUploaded(
	...
	__filemonitor.onLoad = function(s) {
		...
		if(s && this.filesize && this.filesize != 'undefined')
			whatsup = 'Uploading ' + __fSize(this.filesize) + ' ...';
		else if(this.filesize && this.filesize == 'undefined') {
			whatsup = '<div id="info"><img src="../imagenes/mensajes/info48x48.png" align="absmiddle" /> Ejecutando las operaciones necesarias ...<br />Por favor no cierre esta ventana ni recargue la p&aacute;gina</div>';
			if(__maybesomethingwrong++ > 30) {
				__fileloaderInterval = 0;
				whatsup = '<div id="info"><img src="../imagenes/mensajes/info48x48.png" align="absmiddle" /> El proceso se est&aacute; demorando m&aacute;s de los esperado.</div>';
			}
		}
		else {
			whatsup = '<div id="info"><img src="../imagenes/mensajes/info48x48.png" align="absmiddle" /> No se puede encontrar la informaci&oacute;n del servidor.</div>';
			__fileloaderInterval = 0;
		}
