<div id="form">
  <form action="index3.php?op=64&op2=1" method="post" name="geografia" id="geografia">
    <div>
      ...
      <br>
      <br>
      <label for="region">Seleccione el departamento y/o región donde esta la ciudad</label>
      <br>
      <select name="region" id="region" tabindex="2"></select>
      <br>
      <br>
