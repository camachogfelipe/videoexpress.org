...
<div id="form">
	<h3 id="titulos">Subir iglesias de diferente denominación</h3>
  <a href="<?= $servidor ?>/01800admin/archivos_cargue/formatos/formato_iglesia_diferente_denominacion.csv">Descargar formato</a><br><br>
  <form action="<?= $servidor ?>/01800admin/?op=66&op2=5" method="post" name="subir_iglesias" id="subir_iglesias" enctype="multipart/form-data">
