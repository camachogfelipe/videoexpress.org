<div id="form">
  <form action="index3.php?op=62&op2=1" method="post" name="geografia" id="geografia">
    <div>
      ...
      <input name="spanish" id="spanish" type="text" tabindex="2" size="20" maxlength="150">
      <br>
      <br>
      <label for="spanish">Nombre en Ingles</label>
      <input name="english" id="english" type="text" tabindex="3" size="20" maxlength="150">
      <br>
      <br>
    </div>
    <table >
