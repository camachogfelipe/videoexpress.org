...
<link href="estilo.css" rel="stylesheet" type="text/css" />
		<div id="pasos">
            <div id="mitad_izq" style="min-height:480px">
                ...
                <div id="paso" class="paso4">
                    <span id="titulos" class="titulo2-4">
                        <img src="imagenes/numeros-05.png" width="24" height="24" align="absmiddle" /> <?php echo $titulo; ?>
                    </span>
                    <div id="texto_pasos">
                    <?php
						//echo "Total Iglesias: ".count($res)." en ".count($res)." Departamentos/Estados<br /><br />";
						$paises = new regiones($pag);
						$lugar_busqueda = mb_strtolower($_REQUEST['lb'], 'ISO-8859-1');
						$texto_busqueda = mb_strtolower($_REQUEST['tb'], 'ISO-8859-1');
