...
<div id="pasos">
  <div id="mitad_izq2">
    <div id="pasos_region2">
      <div class="pasos_region3">
        <table cellspacing="5" cellpadding="0" align="left" id="pasos_iglesia">
          <tr align="left">
            ...
            <td><p><img src="imagenes/okgris.png" width="25" height="25"></p></td>
            <td width="5%"><?php if($b1 == false || $b1 == NULL || !isset($b1)) { ?>
            	<a id="back" href="#ciudad" onclick="recargar('pasos','<?php echo "r=".$r."&p=".$p."&d=".$d."&c=".$c."&pag=".$pag; ?>')"> <img src="imagenes/back.png" width="24" height="24" title="regresar"> </a><?php } else { ?>
              <a id="back" href="#ciudad" onclick="recargar('busqueda','<?php echo "b=true&pag=".$pag."&tb=".$tb."&lb=".$lb; ?>')"> <img src="imagenes/back.png" width="24" height="24"> </a>
              <?php } ?>
						</td>
          </tr>
        </table>
    ...
    <table cellspacing="0" cellpadding="0" id="color2" class="iglesia">
      ...
      <tr>
        <td>
        	<table  id="pasos_iglesia" cellspacing="0" cellpadding="0" align="center" height="24">
            <tr align="left">
              <td width="3%">&nbsp;</td>
              <td width="37%" valign="top" id="inf_basica"><?php
                ...
                <?php
									if(!empty($iglesia['iglesia'][0]['igl_skype'])) {
										echo '<br /><br /><center><a href="skype:'.$iglesia['iglesia'][0]['igl_skype'].'?call" title="Llamame por skype a '.$iglesia['iglesia'][0]['igl_web'].'" style="color:12A5F4">';
										echo '<img src="imagenes/skype_small.png" border="0" width="60" height="60" /><br />Ll&aacute;manos';
										echo '</a></center>';
									}
								?>
							</td>
              <td width="60%" valign="top" bordercolor="#990000" style="font-size:14px">
              	<span id="titulos"><?php echo ucwords($iglesia['iglesia'][0]['igl_nombre']); ?></span> <br>
                ...
                <p>
                  ...
                  <br>
                  <?php echo $TEXTO['direccion'].': '; echo $iglesia['iglesia'][0]['igl_direccion']; ?> <br>
                  <?php echo $TEXTO['correo'].': '; echo $iglesia['iglesia'][0]['igl_email']; ?>
                </p>
							</td>
            </tr>
            <tr>
              ...
              <td colspan="2" style="font-size:14px">
                ...
                <?php
								...
								?>
                  <a href="index2.php?sec=sac&igl=<?php echo $iglesia['iglesia'][0]['igl_id'] ?>" class="lytebox" data-title="Sugerir actualización de <?php echo ucwords($iglesia['iglesia'][0]['igl_nombre']) ?>" data-lyte-options="width:900 heigh:350 doAnimations:false"> <img src="imagenes/iconos/icono_sugerir.png" width="23" height="19"> <?php echo $TEXTO['link_sugerencia_actualizacion'] ?></a><br>
                  <a href="index2.php?sec=msg&igl=<?php echo $iglesia['iglesia'][0]['igl_id'] ?>" class="lytebox" data-title="escribir a <?php echo ucwords($iglesia['iglesia'][0]['igl_nombre']) ?>" data-lyte-options="width:600 heigh:200 doAnimations:false"> <img src="imagenes/iconos/icono_mensaje.png" width="23" height="19"> <?php echo $TEXTO['link_enviar_mensaje'] ?></a><br>
								<?php } ?>
                </p>
							</td>
            </tr>
  ...
  <div id="mitad_der2">
    <div id="tabs">
      <div id="links">
        <li class="boton" id="color1" href="#tab0">Redes</li>
    ...
    <div id="tab0" class="mitad_der3"> <img id="icono_igl_tabs" src="imagenes/iconos/informacion/icono_info.png" width="50" height="50">
      <div id="igl_tabs"> S&iacute;guenos en:
      	<p>
        	<?php
						if(!empty($iglesia['redes'])) {
							$i = 0;
							foreach($iglesia['redes'] as $valor) {
					?>
					<a class="enlace_red" title="<?= $valor['nombre_red'] ?>" href="<?=$valor['red_url']; ?>" target="_blank"><img id="icono_igl_tabs" src="imagenes/redes/<?=$valor['icono_red']; ?>" width="50" height="50" border="0" alt="<?= $valor['nombre_red'] ?>"></a>
					<?php
							}
						}
						if(!empty($iglesia['iglesia'][0]['igl_img_web']) and !empty($iglesia['iglesia'][0]['igl_web'])) :
							?>
              <a class="enlace_red2" href="<?= $iglesia['iglesia'][0]['igl_web'] ?>" target="_blank" title="web: <?= $iglesia['iglesia'][0]['igl_nombre'] ?>"><img src="<?= "archivos_iglesias/web/".$iglesia['iglesia'][0]['igl_img_web'] ?>" width="95%" /></a>
              <?php
						endif;
					?>
        </p>
    ...
    <div id="tab1" class="mitad_der3"> <img id="icono_igl_tabs" src="imagenes/iconos/icono eventos.png" width="50" height="50">
      <div id="igl_tabs">
        <?php
					if(!empty($iglesia['eventos'])) {
						...
						foreach($iglesia['eventos'] as $valor) {
							...
							if(!empty($valor['evt_imagen']))
								echo '<img src="archivos_iglesias/eventos/'.$valor['evt_imagen'].'" class="no_icon">';
    ...
    <div id="tab3" class="mitad_der3"> <img id="icono_igl_tabs" src="imagenes/iconos/icono sedes.png" width="50" height="50">
      <div id="igl_tabs">
        <?php
...
ucfirst($valor['igl_nombre']).'</a>'."\n";
    ...
    <div id="tab4" class="mitad_der3"> <img id="icono_igl_tabs" src="imagenes/iconos/grupos/icono_sonido.png" width="50" height="50">
      <div id="igl_tabs">
        <div id="mostrar_emisoras"> <a class="player2" id="player2" style="float:left"> <img src="http://static.flowplayer.org/img/player/btn/play_text_large.png"> </a>
          <iframe id="iframe_emisora" src="" width="100%" height="180" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>
        </div>
        <!-- this will install flowplayer inside previous A- tag. -->
        <?php
					if(!empty($iglesia['emisoras'])) {
						//echo "<pre>";print_r($iglesia['video']);echo "</pre>";
						echo '<ul id="emisoras">';
						echo '<div id="emisoras_link">';
						$x = 0;
						foreach($iglesia['emisoras'] as $valor) {
        ...
        <?php
					if(!empty($iglesia['audio'])) {
						...
						echo '<table cellpadding="0" cellspacing="0" width="90%" id="audio">'."\n";
						echo '<tr>'."\n";
    ...
    <div id="tab5" class="mitad_der3"> <img id="icono_igl_tabs" src="imagenes/iconos/icono video nuevo.png" width="50" height="50">
      <div id="igl_tabs">
        <div id="mostrar_videos"> <a class="player" id="player" style="float:left"> <img src="http://static.flowplayer.org/img/player/btn/play_text_large.png"> </a>
          <iframe id="iframe_video" src="" width="100%" height="180" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>
        </div>
        <!-- this will install flowplayer inside previous A- tag. -->
        <?php
