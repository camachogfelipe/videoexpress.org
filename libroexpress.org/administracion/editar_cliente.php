...
if (isset($_SESSION['valid_user']))
{
	...
	if($editar == true)
	{
		...
		$pais		= $_REQUEST['pais'];
		$query = "UPDATE clientes SET cedula='$cedula', nombre='$nombre', apellidos='$apellidos', direccion='$direccion', telefono='$telefono', celular='$celular', correo='$correo', ciudad='$ciudad', pais='$pais'";
