...
<div id='cuerpo' align='center' style='height:100; margin-top:25px; vertical-align:middle; text-align:left; background-color:#D5ECFF'>
  <p><span style='color:#000; padding-left:30px'>Cuentas de LibroExpress.org</span></p>
</div>
...
if ($r == true && $userid != NULL && $con1 == NULL)
{
   ...
   if ($usuario == 0)
   {
      ...
      $cuerpo = "Hola $user
Este es un correo de LibroExpress.org para confirmar la recordación de tu clave de acceso al portal de administración del catalogo.

Por favor da click al siguiente vinculo para confirmar la recordación de tu clave:

http://www.libroexpress.org/libroexpress/administracion/recordacion.php?re=true&to=$token&userid=$userid'
...
if ($r == false && $userid == NULL)
{
   echo "<p style='font-weight:bold'>¿Ha olvidado su contrase&ntilde;a?</p>
       Para iniciar el proceso de recuperación de contraseña, por favor, introduzca su nombre de usuario de LibroExpress.org.
       </div>
