...
if (isset($_SESSION['valid_user']))
{
   ...
   $tabla = "facturas LEFT JOIN dolar_fac_libro USING (`id_factura`)";
   $datos = "facturas.*, dolar_fac_libro.dolar_factura";
    ...
    <td bgcolor="#ebebeb" align="center">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tabla">
      <tr align="center" id="encabezado_tablas">
        ...
        <td rowspan="2" width="6%"><a href="lista_facturas.php?ord=6&pag<?php echo $pag; ?>"><img src="imagenes/ordenar.png" alt="" width="15" height="15" border="0" /></a> Dolar de ese día</td>
      ...
      while ($row = mysql_fetch_object($result))
     {
      ...
      //dolar facturado
      $dolar_facturado = $row->dolar_factura;
      echo "<td>$ ".number_format($dolar_facturado,2)."</td>";
      //accion
      echo "<td>";
      echo "<a href=\"factura_facturas.php?id=$id&tabla=facturas\"><img src=\"imagenes/ver.png\" border=\"0\" width=\15\" height=\"15\" align=\"absmiddle\">Ver factura para imprimir</a></td>";
      echo "</tr>";
     }
     ?>
     </table>
