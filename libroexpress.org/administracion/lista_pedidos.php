    ...
    <td bgcolor="#ebebeb" align="center">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tabla">
      <tr align="center" id="encabezado_tablas">
        <td rowspan="2" width="3%"><a href="lista_pedidos.php?ord=1&pag<?php $pag++; echo $pag; ?>"><img src="imagenes/ordenar.png" width="15" height="15" border="0" /></a> Id</td>
        <td rowspan="2"  width="11%"><a href="lista_pedidos.php?ord=2&pag<?php echo $pag; ?>"><img src="imagenes/ordenar.png" alt="" width="15" height="15" border="0" /></a> Datos Comprador</td>
        <td colspan="2">Art&iacute;culos comprados</td>
        <td colspan="2"  width="12%"><a href="lista_pedidos.php?ord=3&pag<?php echo $pag; ?>"><img src="imagenes/ordenar.png" alt="" width="15" height="15" border="0" /></a> Valor  Factura</td>
        <td rowspan="2"  width="11%"><a href="lista_pedidos.php?ord=4&pag<?php echo $pag; ?>"><img src="imagenes/ordenar.png" alt="" width="15" height="15" border="0" /></a> Fecha de emisi&oacute;n</td>
        <td rowspan="2"  width="8%"><a href="lista_pedidos.php?ord=5&pag<?php echo $pag; ?>"><img src="imagenes/ordenar.png" alt="" width="15" height="15" border="0" /></a> Dolar para facturar</td>
        <td rowspan="2"  width="15%">Acci&oacute;n</td>
      </tr>
      <tr align="center" id="encabezado_tablas">
       <td width="33%">T&iacute;tulo</td>
      ...
      while ($row = mysql_fetch_object($result))
     {
      ...
      echo "<td align=\"center\">$ ".number_format($trm,2)."</td>";
      //accion
      echo "<td>";
      echo "<a href=\"cancelar_factura.php?id=$id&anular=true\"><img src=\"imagenes/borrar.png\" border=\"0\" width=\15\" height=\"15\" align=\"absmiddle\">Anular pedido</a><br />";
      echo "<a href=\"cancelar_factura.php?id=$id\"><img src=\"imagenes/cancelar_pedido.png\" border=\"0\" width=\15\" height=\"15\" align=\"absmiddle\">Generar la factura</a><br />";
      echo "<a href=\"factura.php?id=$id&tabla=pedidos\"><img src=\"imagenes/ver.png\" border=\"0\" width=\15\" height=\"15\" align=\"absmiddle\">Ver factura para imprimir</a></td>";
      echo "</tr>";
     }
     ?>
     </table>
