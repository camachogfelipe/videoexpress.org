...
function BytesUploaded(
	...
	__filemonitor.onLoad = function(s) {
		...
		if(s && this.filesize && this.filesize != 'undefined')
			...
			whatsup = '<span id="info">Ejecutando las operaciones necesarias ...<br />Por favor no cierre esta ventana ni recargue la p&aacute;gina</span>';
			if(__maybesomethingwrong++ > 30) {
				__fileloaderInterval = 0;
				whatsup = 'el proceso se est&aacute; demorando m&aacute;s de los esperado.';
			}
		}
		else {
